...
\link{http://en.wikipedia.org/wiki/Danaus_(genus)}{genus} of a butterly.  Not
...
\java{Park}\footnote{\java{Map}s and \java{Tile}s are explained in much greater
...
\begin{wrapfigure}{l}{0.075\textwidth}
    ...
    \vspace{-20pt}
\end{wrapfigure}
The tall and dense trees of a \java{Forest} tile are flyable but difficult to
fly over. When a butterfly flies over a \java{Forest}, \java{slowSteps} is
incremented by 1.
