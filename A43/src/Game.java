...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        Board b= new Board();
        Game.fillColumn(b, Board.Player.RED, 0);
        Game.fillColumn(b, Board.Player.RED, 1);
        Game.fillColumn(b, Board.Player.RED, 2);
        Game.fillColumn(b, Board.Player.YELLOW, 3);
        Game.fillColumn(b, Board.Player.RED, 4);
        //Game.fillColumn(b, Board.Player.YELLOW, 5);
        
        //Move[] x =b.getPossibleMoves(Board.Player.YELLOW);
        //System.out.println(x[0].toString());
        State s = new State(Board.Player.RED, b, null);
        s.initializeChildren();
        //System.out.println(b.toString());
        //System.out.println(s.getChildren()[0].toString());
